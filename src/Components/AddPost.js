                    ...
                    {showCommentInput[post.id] && (
                        <aside>
                            ...
                            <div className="flex">
                                ...
                                <form>
                                    <div className="flex-1 px-1 pt-2 mt-4">
                                        <textarea ref={textbox}  onChange={handleChangeReplay} 
                                    id={`comment-input-${post.id}`}
                                    className="resize-none outline-none bg-transparent text-gray-400 font-medium text-lg md:w-fit w-[300px]" rows="1" cols="50" placeholder="Post Your Replay" />
                                    </div>
                                </form>
                            </div>  
                            <div className="flex">
